namespace StaticProxy.Fody.Tests.ClassDecoration.ConstructorWeaving
{
    ...
    public class When_proxying_class_with_static_constructor : SimpleTestBase
    {
        private readonly Type clazz;

        public When_proxying_class_with_static_constructor()
        {
            this.clazz = this.WovenSimpleTestAssembly.GetType("SimpleTest.ClassDecoration.ClassWithStaticConstructor");
        }
